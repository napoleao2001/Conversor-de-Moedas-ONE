...
public class ConversorAPI {
    ...
    public String conversorMOEDAS(String moedaEntrada, String moedaSaida) throws IOException, InterruptedException{

        final String URL = "https://api.invertexto.com/v1/currency/"+moedaEntrada+"_"+moedaSaida+"?token="+URLEncoder.encode(API_KEY, StandardCharsets.UTF_8.toString());
